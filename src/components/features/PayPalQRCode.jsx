...
const PayPalQRCode = () => {
  ...
  const updateQRCode = () => {
    ...
    const url = `https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=${encodeURIComponent(email)}&item_name=${encodeURIComponent(itemName)}&item_number=${encodeURIComponent(itemId)}&amount=${price}&currency_code=${currency}&shipping=${shipping}&tax_rate=${taxRate}&paymentaction=${paymentType}`;
